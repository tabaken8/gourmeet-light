    ...
    <main className="mx-auto w-full max-w-2xl px-4 pb-24 pt-6 md:pb-10">
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            ...
            <span className="font-semibold">未投稿</span> の場合に限り、招待コードを後から適用できます。
          </p>
        </div>
      ...
      <section className="rounded-2xl border border-black/10 bg-white p-5 shadow-[0_10px_40px_rgba(0,0,0,0.06)]">
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-base font-bold">招待コード</div>
            <div className="mt-1 text-sm text-gray-600">
              友だちの招待コードを適用できます（失敗/入れ忘れ救済）。
            </div>
          </div>
        ...
        {msg && (
          <div className="mt-3 rounded-2xl bg-black/[.03] p-3 text-sm text-gray-800">
            {msg}
          </div>
        )}
