  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 pb-24 pt-6 md:pb-10">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-slate-800">
        ...
        <section>
          <h2 className="mb-2 font-semibold text-slate-800">1. 取得する情報</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-semibold text-slate-800">2. 利用目的</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-semibold text-slate-800">3. 第三者提供</h2>
          <p>
